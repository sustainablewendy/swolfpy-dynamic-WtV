...
class Ui_adv_opt(object):
    ...
    def retranslateUi(self, adv_opt):
        adv_opt.setWindowTitle(QCoreApplication.translate("adv_opt", "Optimization setting", None))
        self.groupBox_2.setTitle(
            QCoreApplication.translate("adv_opt", "Collection scheme decision variables", None)
        )
        self.groupBox.setTitle(QCoreApplication.translate("adv_opt", "Options", None))
        self.label_2.setText(QCoreApplication.translate("adv_opt", "Initial guess", None))
        self.label.setText(QCoreApplication.translate("adv_opt", "Number of theads", None))
        self.Multi_start_opt.setText(QCoreApplication.translate("adv_opt", "Multi_start", None))
        self.Opt_incld_col.setText(
            QCoreApplication.translate("adv_opt", "Optimize collection scheme", None)
        )
        self.label_3.setText(QCoreApplication.translate("adv_opt", "Timeout", None))
